...
<head>
    ...
    <style>
        ...
        .bg-glow{
            ...
            background:
                radial-gradient(600px circle at 20% 15%, rgba(58,148,255,0.10), transparent 60%),
...
<body class="flex items-center justify-center px-4">
    ...
    <div class="relative z-10 w-full max-w-sm">
        ...
        <div class="text-center mb-8">
            <h1 class="font-display text-2xl font-semibold text-[var(--text)]">
        ...
        <div class="bg-[var(--surface)] border border-[var(--hairline)] rounded-2xl p-7 shadow-2xl">
            ...
            @if ($errors->any())
                <div class="mb-5 rounded-xl px-4 py-3 text-xs bg-red-50 border border-[var(--crimson)] text-[var(--crimson)]">
                    {{ $errors->first() }}
                </div>
            @endif
